...
class Movie(models.Model):
    ...
    budget = models.PositiveSmallIntegerField("Бюджет", default=0, help_text="Указывать сумму в "
                                                                             "долларах")
    fees_in_usa = models.PositiveSmallIntegerField("Сборы в США", default=0,
                                                   help_text="Указывать сумму в долларах")
    fees_in_world = models.PositiveSmallIntegerField("Сборы в в мире", default=0,
                                                     help_text="Указывать сумму в долларах")
